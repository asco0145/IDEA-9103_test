...
function calculateImageProperties(){
  //Check if the image is wider than the canvas
  if (imageProperties.aspect > canvasAspectRatio){
    ...
    /*Offset tells us how much we need to move things horizontally 
    or vertically to fit the screen. */
    imageProperties.yOffset = (height - imageProperties.height) / 2;
    imageProperties.xOffset = 0

  //Check if the image is longer than the canvas
